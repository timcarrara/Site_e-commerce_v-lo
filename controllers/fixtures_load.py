...
=======
    sql='''
    DROP TABLE IF EXISTS ligne_panier, ligne_commande, commande, utilisateur, etat, velo, taille, type_velo;
>>>>>>> f4232e7cc76f10f5f323de41280b5bb7d09572ef
    '''
    mycursor.execute(sql)
