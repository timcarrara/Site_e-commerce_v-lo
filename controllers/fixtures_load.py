...
def fct_fixtures_load():
    ...
    sql = '''DROP TABLE IF EXISTS adresse, ligne_panier, ligne_commande,
             commande, etat, declinaison_velo, velo, utilisateur, type_velo, taille, couleur;'''
    ...
    commande_id INT,
    velo_declinaison_id INT,
    prix NUMERIC(10,2),
    quantite_commande INT,
    PRIMARY KEY (commande_id, velo_declinaison_id),
    FOREIGN KEY (commande_id) REFERENCES commande(id_commande) ON DELETE CASCADE,
    FOREIGN KEY (velo_declinaison_id) REFERENCES declinaison_velo(id_declinaison_velo)
    ) DEFAULT CHARSET=utf8;'''
    mycursor.execute(sql)
    ...
    date_ajout DATETIME,
    quantite_panier INT,
    PRIMARY KEY (utilisateur_id, velo_declinaison_id, date_ajout),
    FOREIGN KEY (utilisateur_id) REFERENCES utilisateur(id_utilisateur),
    FOREIGN KEY (velo_declinaison_id) REFERENCES declinaison_velo(id_declinaison_velo)
    ) DEFAULT CHARSET=utf8;'''
    mycursor.execute(sql)
    ...
    (10, 1599.00, 'kona-rove-se.jpg', 1, 4, 8),
    (5, 1599.00, 'kona-rove-se.jpg', 1, 6, 6),
    (0, 1599.00, 'kona-rove-se.jpg', 1, 2, 7),
    (0, 2099.99, 'vitus-mythique-29-vrs.jpg', 2, 1, 1),
    ...
    (9, 289.00, 'scool-nixe-alloy-18-kids.jpg', 8, 2, 7),
    (5, 289.00, 'scool-nixe-alloy-18-kids.jpg', 8, 2, 2),
    (9, 289.00, 'scool-nixe-alloy-18-kids.jpg', 8, 2, 5),
    ...
    (0, 6499.00, 'cube-aerium-c68-sl-low.jpg', 13, 6, 3),
    (3, 6499.00, 'cube-aerium-c68-sl-low.jpg', 13, 4, 6),
    (0, 6499.00, 'cube-aerium-c68-sl-low.jpg', 13, 5, 3),
    ...
    (0, 629.99, 'wethepeople-arcade.jpg', 17, 1, 1),
    (19, 629.00, 'winora-domingo-21-diamond.jpg', 18, 1, 1),
    (4, 6199.00, 'vitus-escarpe-29-amp-intl-vitus.jpg', 19, 5, 1),
    (1, 6199.00, 'vitus-escarpe-29-amp-intl-vitus.jpg', 19, 2, 1),
    (22, 3519.00, 'kona-dew-e-dl.jpg', 20, 1, 1),
    (24, 2299.00, 'ridley-bikes-kanzo-a-rival-1.jpg', 21, 1, 6),
    (6, 2299.00, 'ridley-bikes-kanzo-a-rival-1.jpg', 21, 1, 3);
    '''
    mycursor.execute(sql)
